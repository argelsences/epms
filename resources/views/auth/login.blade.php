...
<div class="container" style="height: auto;">
  <div class="row align-items-center">
    <div class="col-md-9 ml-auto mr-auto mb-3 text-center">
      <h3>Event Publication and Poster Management System</h3>
    </div>
      ...
      <form class="form" method="POST" action="{{ route('login') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          <div class="card-header card-header-primary text-center">
            <h4 class="card-title text-light"><strong>{{ __('Login') }}</strong></h4>
          ...
          <div class="card-body">
            <p class="card-description text-center">Sign in with your credentials</p>
            <div class="bmd-form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
              <div class="input-group">
                ...
                <input type="email" name="email" class="form-control" placeholder="{{ __('Email...') }}" value="{{ old('email', 'admin@fqdn.com') }}" required>
              </div>
              @if ($errors->has('email'))
