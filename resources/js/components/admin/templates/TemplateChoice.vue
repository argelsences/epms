<template>
    <v-app>
        <div class="text-h4 text-left">Create template</div>
                    ...
                    <v-card-text>
                        <v-container>
                            <v-list class="text-left">
                                ...
                                <v-list-item link :to="{name: `add-by-canvas`}" class="ma-5" disabled>
                                    <v-list-item-action>
                                        <v-icon>mdi-bullhorn</v-icon>
                                    </v-list-item-action>
                                    <v-list-item-content>
                                        <v-list-item-title>By using drawing canvas.</v-list-item-title>
                                    </v-list-item-content>
                                </v-list-item>
                            </v-list>
                        </v-container>
